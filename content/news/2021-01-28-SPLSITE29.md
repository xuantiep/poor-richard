...
The extent to which the Pennsylvania Health Department is involved in the scheduling process is minimal: It has a map posted to its website with clickable pins showing where vaccines might be available. Spotlight PA has also created <a href="https://lesspage.com/news/2021/01/pa-covid-vaccine-locations-availability-where-to-get-who-can-get-latest-updates/" target=_blank>an easier, county-by-county listing of providers</a>.
